...
2. **单向依赖**：`sdkwork-appbase`、`sdkwork-claw-router` 等 → `sdkwork-web-framework`；禁止反向
...
见 [00-framework-foundation.md](../00-framework-foundation.md) §10 验收清单。

## References

- [00-framework-foundation.md](../00-framework-foundation.md)
